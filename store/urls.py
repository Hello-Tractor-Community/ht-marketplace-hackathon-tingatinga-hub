...
urlpatterns = [
    ...
    path('store/job-application/', views.JobApplicationView, name="job-application"),
    path('store/job-posting/', views.JobPostingView, name="job-posting"),
    path('store/send-sms/', views.InAppMessageView, name="send-sms"),
    path('store/product-comparison/', views.product_comparison, name="product_comparison"),
